...
def render_beyond_the_work(label, headline, yoga_label, yoga_copy, yoga_image, yoga_alt,
    ...
    if wedding_label and wedding_copy:
        wedding_panel = (
            '<div>'
            f'<div style="height:320px;overflow:hidden;border-radius:10px;margin-bottom:1rem;">{wedding_img}</div>'
            f'<span style="font-family:\'JetBrains Mono\',monospace;font-size:0.85rem;'
            f'font-weight:600;letter-spacing:0.1em;text-transform:uppercase;'
    ...
    html = (
        ...
        # Yoga panel
        '<div>'
        f'<div style="height:320px;overflow:hidden;border-radius:10px;margin-bottom:1rem;">{yoga_img}</div>'
        f'<span style="font-family:\'JetBrains Mono\',monospace;font-size:0.85rem;'
        f'font-weight:600;letter-spacing:0.1em;text-transform:uppercase;'
        ...
        # Dogs panel
        '<div>'
        f'<div style="height:320px;overflow:hidden;border-radius:10px;margin-bottom:1rem;">{home_img}</div>'
        f'<span style="font-family:\'JetBrains Mono\',monospace;font-size:0.85rem;'
        f'font-weight:600;letter-spacing:0.1em;text-transform:uppercase;'
